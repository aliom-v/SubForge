...
如果你只是自己部署、自己使用，通常先看 `docs/部署指南.md` 和 `docs/排障与常见问题.md` 就够了；这篇更偏发布、回滚、巡检和告警值班手册。
...
- 具体部署步骤统一放到 `docs/部署指南.md`
- GitHub Actions 输入项、备份 / 恢复 SOP 与对象存储归档细节统一放到 `docs/高级部署与数据维护.md`
